...
def update_overall_metrics(fold, fold_best_epoch, homophily_index, feat_names, relevant_features, feature_importances, fold_performance, fold_losses, dict_val_metrics, dict_test_metrics, features_track):
    """
    ...
    # Record the importance scores for the relevant features
    features_track["Raw_Feature_Importances"].append(feature_importances)
