...
df_train = pd.read_csv('/proposal_data/data_splits/initital_split/train_data.csv')
...
df_train_trans.to_csv('/Users/nickq/Documents/Pioneer Academics/Research_Project/proposal_data/datasets_processed/lasso_output/train_transformed_features.csv', index=False)
...
df_selected.to_csv('/Users/nickq/Documents/Pioneer Academics/Research_Project/proposal_data/datasets_processed/lasso_output/selected_features.csv', index=False)
