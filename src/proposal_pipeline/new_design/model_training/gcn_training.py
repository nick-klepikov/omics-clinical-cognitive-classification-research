...
if __name__ == '__main__':
    ...
    device = check_cuda()
    # I/O
    OUT_DIR = "/Users/nickq/Documents/Pioneer Academics/Research_Project/proposal_data/final_res/" + myconfig.model_name + "/"
    ...
    if os.path.exists(OUT_DIR):
        ...
        os.makedirs(OUT_DIR)
    mastertable_file = "/proposal_data/datasets_processed/lasso_output/train_transformed_features.csv"
    ...
    for fold, (train_msk, val_msk) in enumerate(zip(train_masks, val_masks)):
        ...
        # build network
        adj = similarity_network(s_threshold=myconfig.S_threshold, X_df=pd.DataFrame(data=X, columns=features_name, index=X_indices))
